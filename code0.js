...
gdjs.s2Code.GDcontarObjects1= [];
gdjs.s2Code.GDcontarObjects2= [];
...
gdjs.s2Code.GDcontarObjects1.length = 0;
gdjs.s2Code.GDcontarObjects2.length = 0;
...
gdjs.s2Code.conditionTrue_1.val = context.triggerOnce(208543124);
}
}if (gdjs.s2Code.condition0IsTrue_0.val) {
{gdjs.evtTools.sound.playMusic(runtimeScene, "oh1.ogg", true, 100, 1);
}}
...
gdjs.s2Code.GDcontarObjects2.createFrom(runtimeScene.getObjects("contar"));
...
}{for(var i = 0, len = gdjs.s2Code.GDcontarObjects2.length ;i < len;++i) {
    gdjs.s2Code.GDcontarObjects2[i].hide();
}
